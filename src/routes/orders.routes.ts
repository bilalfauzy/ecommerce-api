...
import { cancelOrders, changeStatus, createOrder, getOrderById, listAllOrders, listOrders, listUserOrders } from '../controllers/orders.controller'
...
orderRoutes.put('/:id/cancel', [authMiddleware], errorHandler(cancelOrders))
